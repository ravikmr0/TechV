...
const clients = [
  ...
  { name: "Adobe", logo: "https://upload.wikimedia.org/wikipedia/commons/5/5f/Adobe_Systems_logo_and_wordmark.svg" },
  ...
  { name: "Stripe", logo: "https://upload.wikimedia.org/wikipedia/commons/4/4f/Stripe_Logo%2C_revised_2016.svg" },
  { name: "PayPal", logo: "https://upload.wikimedia.org/wikipedia/commons/b/b5/PayPal.svg" },
  { name: "Shopify", logo: "https://upload.wikimedia.org/wikipedia/commons/0/0e/Shopify_logo_2018.svg" },
  { name: "HubSpot", logo: "https://upload.wikimedia.org/wikipedia/commons/7/77/HubSpot_Logo.svg" },
  { name: "Atlassian", logo: "https://upload.wikimedia.org/wikipedia/commons/5/5e/Atlassian-logo.svg" },
  ...
  return (
    <section className="py-20 bg-slate-50">
      <div className="container mx-auto px-4">
        ...
        <div className="mb-16" onMouseEnter={() => setPaused(true)} onMouseLeave={() => setPaused(false)}>
          <Carousel
            setApi={setApi}
          ...
          >
            <CarouselContent>
              {clients.map((client, index) => (
                ...
                >
                  <div className="flex items-center justify-center p-6 rounded-lg hover:bg-white hover:shadow-xl transition-all duration-300 h-full">
                    <img
                      src={client.logo}
                      alt={client.name}
